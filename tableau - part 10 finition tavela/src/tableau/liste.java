...
public class liste {
    ...
    private Integer prixsac,punitaire;
    private Integer prixKilo;
    private Integer TVA;

    public liste(Integer id,String nomproduit, Integer prixKp, Integer prixsac, Integer prixKilo, Integer TVA,Integer punitaire) {
        this.id =id;
     ...
     */
    public void setPunitaire(Integer punitaire) {
        this.punitaire = punitaire;
    }
